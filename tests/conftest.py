...
# WARNING: Ensure imports from `fastapi_boilerplate` comes after this line
from fastapi_boilerplate import app, settings, db  # noqa
from fastapi_boilerplate.cli import create_user, cli  # noqa
